...
fun ForgotMail(
    ...
    Scaffold(
        ...
        Column(
            ...
            Text(
                text = "Enter the mail you registered. An OTP will be sent to this mail and you can use this OTP to log in.",
                color = Color.White,
            ...
            OutlinedButton(
                onClick = {
                    navController.navigate(Routes.forgotOTP){
                        popUpTo(Routes.forgotEmail){
                            inclusive = true
                        }
...
@Composable
@Preview
fun ForgotMailPreview(){
    ForgotMail(navController = NavController(LocalContext.current))
}